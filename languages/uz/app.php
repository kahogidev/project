...
//    slider page
    "slider1" => "Sayohat orqali maroq oling!",
    "sliders1" => "Dunyo bo'ylab sayohat qilish inson hayotida ulkan burilishlar yasaydi! Shunday ekn hoziroq sayohatga buyurtma bering va biz bilan dunyo kezing!!!",
    "slider2" => "BIZ BILAN",
...
//    About page
    ...
    "about2" => "Ishonchli xizmat",
    "about3" => "Eng yaxshi sayohat agentligi",
...
//    Counter page
    ...
    "counter1" => "Mijozlar",
    "counter2" => "Ajoyib sayohatlar",
    "counter3" => "Chipta bron qilish",
    "counter4" => "Mehmonxonalar",
